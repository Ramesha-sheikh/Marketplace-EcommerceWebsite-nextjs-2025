          ...
          >
            ...
            <div className="absolute top-2 right-2 z-10">
              <button
                ...
                className="flex items-center justify-center w-8 h-8 bg-white rounded-full border border-gray-300 shadow-md"
              >
                <CiHeart
                  className="cursor-pointer"
                  color={isInWishlist(product._id) ? "red" : "gray"}
                  size={20} // Adjusted the size for better alignment
                />
              </button>
            </div>
          </div>
